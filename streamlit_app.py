...
# Set the layout width of the app.
...
# Adding some formatting to the shortcut button on the left sidebar.
load_keyboard_class()
...
# Display the menu bar in sidebar
with st.sidebar:
...
# Display the shortcuts in sidebar
...
# Display information about Streamlit in sidebar
...
st.sidebar.markdown(
    """
App created by [roshinifer333](https://twitter.com/roshinifer333) using 🎈[Streamlit](https://streamlit.io/) and [HuggingFace](https://huggingface.co/inference-api)'s [Distilbart-mnli-12-3](https://huggingface.co/valhalla/distilbart-mnli-12-3) model.
Learnt from [DataChaz](https://twitter.com/DataChaz). 
"""
)
